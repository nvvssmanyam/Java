...
<script type="text/javascript" charset="utf8" src="resources/js/bootstrap-treeview.min.js"></script>
...
<body>
    <div class="container-fluid">
        <div class="appHeader">
        <img src="resources/img/inmar-logo-web-2x.png" alt="inmar" class="appLogo">
        </div>
        <div class="container">
            <div>
            ...
            <!-- Modal -->
            <div class="row">
	            <div class="modal entityModel" id="addEntityModal" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle" aria-hidden="true">
            ...
            <div class="row form-group">
                ...
                <div class="well clearfix col-md-12">
                    ...
                    <div class="panel panel-default deptsDiv">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" id="deptsOfLoc"/>
                            <div class="row form-group"></div>
                    ...
                    <div class="panel panel-default catgsDiv">
                        ...
                        <div class="panel-body">
                            ...
                            <input type="hidden" id="catgsOfDept"/>
                            <div class="row form-group"></div>
                ...
                <!-- Alert Model -->
                <div class="modal" id="alert-modal" role="dialog" aria-labelledby="modalCenterTitle" aria-hidden="true">
